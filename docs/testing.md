...
6. `tests/qml/`: QML texture/phase render, model-to-helper lifecycle, and validated atomic-state persistence tests—including save, reset, clear-active, reorder, and saved-place switching—in offscreen Quickshell.
